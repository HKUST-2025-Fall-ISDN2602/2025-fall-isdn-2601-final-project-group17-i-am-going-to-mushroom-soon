...
const int BASE_TARGET = 5;  // Base: Rotate left to target object (adjust angle)
const int BASE_BOX = 180;

const int EXTEND_HOME = 80;  // Arm: Retracted (shortest)
const int EXTEND_BOX = 120;
const int EXTEND_TARGET = 120;// Arm: Extended to reach object (adjust length)
...
const int WRIST_GRAB =  0;   // Wrist: Tilt slightly to better grab object
